# -Attendance-Management-System-using-Face-Recognition by MattaGayatri Bhat
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/MattaGayatri/Attendance-Management-System-using-Face-Recognition.git
